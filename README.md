...
1. The filtered data used for instruction-finetuning the model.
2. The code for filtering the data.
3. The scripts for fine-tuning the model.
4. The code and scripts for the evaluations. 
